...
import ru.yarm.clinic.Services.NewsService;
...
public class HelloController {
    ...
    public String firstActivation(Model model, @PathVariable String code) {

        boolean isActivated = userService.activateUser(code);

        if (isActivated) {
            model.addAttribute("message", "Ваша учетная запись активирована. Можете аутентифицироваться!");
        } else {
            model.addAttribute("message", "Такой учетной записи не существует. Активация невозможна!");
        }
